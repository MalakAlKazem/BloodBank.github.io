        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 lg-12 sm-12">
              ...
              <h1 class="page-title"style="font-size:3em">Donor List</h1>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" style="text-align:center">
                <thead style="text-align:center">
                  ...
                  <th style="text-align:center">ActionDelete</th>
                  <th style="text-align:center">ActionUpdate</th>
                </thead>
                <tbody>
                  <?php
                  while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                      ...
                      <td id="he" style="width:100px">
                        <a style="color: red;" href='delete.php?id=<?php echo $row['donor_id']; ?>'> Delete </a>
                      </td>
                      <td>
                      <a href='updateDonor.php?id=<?php echo $row['donor_id']; ?>' style="color: blue;">Update</a>
            </td>
                    </tr>
                  <?php } ?>
                </tbody>
