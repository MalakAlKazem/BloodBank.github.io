    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12 lg-12 sm-12">
          ...
          <h1 class="page-title"style="font-size:3em">Change Password</h1>
        </div>
      </div>
          <div class="row">
            <div class="col-md-10">
            ...
            if (md5($password) == $row['admin_password']) {
                ...
                if ($newpassword == $confpassword) {
                    if ($newpassword != $password) {
                        ...
                        $sql1 = "UPDATE admin_ifo SET admin_password='{$hashed_newpassword}' WHERE admin_username='{$username}'";
                        ...
                        echo  '<div class="alert alert-info alert_dismissible"><button type="button" class="close" data-dismiss="alert">&times;</button><b>New Password cannot be the same as the Current Password.</b></div>';
                    }
                } else {
