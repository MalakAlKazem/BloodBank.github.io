    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12 lg-12 sm-12">
          <b><h1 class="page-title "style="font-size:3em">Dashboard</h1></b>
        </div>
      </div>
      <hr>
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="panel panel-default panel-info" style="border-radius:50px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#D8BFD8;border-radius:50px;">
                  <div class="stat-panel text-center">
                    <?php
                    ...
                    <div class="stat-panel-title text-uppercase"> All Users Messages </div>
                    <br>
            ...
            <div class="col-md-4">
              <div class="panel panel-default panel-info" style="border-radius:50px;">
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#F5DEB3 ;border-radius:50px; ">
                  <div class="stat-panel text-center">
                    <?php
