...
$sql= "insert into contact_query (query_name,query_number,query_message,query_mail,query_status) values('{$name}','{$number}','{$message}','{$email}',2)";
  ...
  <div id="content-wrap" style="padding-bottom:50px;">
    ...
    <div class="row">
      <div class="col-lg-8 mb-4">
        ...
        <form name="sentMessage"  method="post" style="border: 1px solid black; padding:20px">
            ...
            <center><button type="submit" name="send"  class="btn btn-primary">Send Message</button></center>
        </form>
    </div>
